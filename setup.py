...
setup(
    name='MLW',
    description='Marine Litter Watch (MLW) Plastic Pollution',
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    version=os.environ.get('MLW_VERSION', '0.0.0'),
    keywords='hacktheplanet mlw api',
    license='MIT',
    author='Jose Angel Munoz',
    author_email='josea.munoz@gmail.com',
    url='https://github.com/imjoseangel/hacktheplanet2021',
    packages=['mlw'],
    classifiers=[
